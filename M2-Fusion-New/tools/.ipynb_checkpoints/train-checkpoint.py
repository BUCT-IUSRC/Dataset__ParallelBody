...
def parse_config():
    ...
    parser.add_argument('--tcp_port', type=int, default=23344, help='tcp port for distrbuted training')
    ...
    parser.add_argument('--save_to_file', action='store_true', default='./out', help='')
